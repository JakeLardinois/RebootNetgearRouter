...
Inside of App.config you need to specify
	DestinationPingAddress which is the address that will be pinged to check for network connectivity. It can be an IP Address or a name; basically anything
		that would be specified in a Ping command.
